...
def run_test_practice_problem2a():
    ...
    # Test 2
    print("Test 2: ")
    expected = [36, 22, 5, 4, 19, 238]
    sequence = [16, 2, -15, -16, -1, 218]
    actual = practice_problem2a(sequence, 20)
    print("Expected: " + str(expected))
    print("Actual: " + str(actual))

    # Test 3
    print("Test 3: ")
    expected = [1, 2, 20, 9, 39]
    sequence = [1, 2, 20, 9, 39]
    ...
    expected = [8]
    sequence = [200]
    actual = practice_problem2a(sequence, -192)
    print("Expected: " + str(expected))
    print("Actual: " + str(actual))
